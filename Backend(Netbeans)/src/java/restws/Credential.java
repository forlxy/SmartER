...
@NamedQueries({
    ...
    , @NamedQuery(name = "Credential.findByPasswdHash", query = "SELECT c FROM Credential c WHERE c.passwdHash = :passwdHash")
...
public class Credential implements Serializable {
    ...
    public Credential(String username, String passwdHash, Date regdate) {
        this.username = username;
    ...
    public String toString() {
        return "re.Credential[ username=" + username + " ]";
    }
